...
(function (e, t) {
    ...
    At.optgroup = At.option, At.tbody = At.tfoot = At.colgroup = At.caption = At.thead, At.th = At.td, b.fn.extend({text:function (e) {
        ...
        if (p && (l = b.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
            ...
            if (a)for (u = s[s.length - 1].ownerDocument, b.map(s, qt), c = 0; a > c; c++)o = s[c], kt.test(o.type || "") && !b._data(o, "globalEval") && b.contains(u, o) && (o.src ? b.ajax({_url:o.src, type:"GET", dataType:"script", async:!1, global:!1, "throws":!0}) : b.globalEval((o.text || o.textContent || o.innerHTML || "").replace(St, "")));
            l = i = null
        }
        return this
    }});
    ...
    b.fn.load = function (e, n, r) {
        ...
        return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)), b.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (a = "POST"), s.length > 0 && b.ajax({_url:e, type:a, dataType:"html", data:n}).done(function (e) {
        ...
        u = p.global, u && 0 === b.active++ && b.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Cn.test(p.type), o = p._url, p.hasContent || (p.data && (o = p._url += (bn.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p._url = wn.test(o) ? o.replace(wn, "$1_=" + vn++) : o + (bn.test(o) ? "&" : "?") + "_=" + vn++)), p.ifModified && (b.lastModified[o] && N.setRequestHeader("If-Modified-Since", b.lastModified[o]), b.etag[o] && N.setRequestHeader("If-None-Match", b.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && N.setRequestHeader("Content-Type", p.contentType), N.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Dn + "; q=0.01" : "") : p.accepts["*"]);
    ...
    b.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents:{script:/(?:java|ecma)script/}, converters:{"text script":function (e) {
        ...
        if (e.crossDomain) {
            ...
            return{send:function (t, i) {
                n = o.createElement("script"), n.async = !0, e.scriptCharset && (n.charset = e.scriptCharset), n.src = e._url, n.onload = n.onreadystatechange = function (e, t) {
    ...
    b.ajaxSetup({jsonp:"callback", jsonpCallback:function () {
        ...
        var o, a, s, u = n.jsonp !== !1 && (Bn.test(n._url) ? "_url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Bn.test(n.data) && "data");
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = b.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Bn, "$1" + o) : n.jsonp !== !1 && (n._url += (bn.test(n._url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function () {
    ...
    b.ajaxSettings.xhr = e.ActiveXObject ? function () {
        ...
        if (!n.crossDomain || b.support.cors) {
            ...
            return{send:function (i, o) {
                var a, s, u = n.xhr();
                if (n.username ? u.open(n.type, n._url, n.async, n.username, n.password) : u.open(n.type, n._url, n.async), n.xhrFields)for (s in n.xhrFields)u[s] = n.xhrFields[s];
