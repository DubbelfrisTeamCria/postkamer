...
JSON || (JSON = {}), function () {
    ...
    function d(e, t) {
        ...
        e.forEach(function (e, t) {
            if (!e.type)return;
            var s = n(e.type);
            s.async ? s.fromObject(e, function (e, n) {
                n || (i[t] = e), r()
    ...
    function m(e, t, n) {
        if (n && Object.prototype.toString.call(n) === "[object Array]")for (var r = 0, i = n.length; r < i; r++)t[n[r]] = e[n[r]]
    }

    function g(n, r, i, s, o, u) {
    ...
    fabric.util.removeFromArray = n, fabric.util.degreesToRadians = s, fabric.util.radiansToDegrees = o, fabric.util.rotatePoint = u, fabric.util.toFixed = a, fabric.util.getRandomInt = r, fabric.util.falseFunction = f, fabric.util.animate = l, fabric.util.requestAnimFrame = h, fabric.util.loadImage = p, fabric.util.enlivenObjects = d, fabric.util.groupSVGElements = v, fabric.util.populateWithProperties = m, fabric.util.drawDashedLine = g, fabric.util.createCanvasElement = y, fabric.util.createImage = b, fabric.util.createAccessors = w, fabric.util.clipContext = E, fabric.util.multiplyTransformMatrices = S
}(), function () {
    function t(t, n) {
    ...
    function p(e, t) {
        ...
        while (n && n.parentNode && !a)n = n.parentNode, n !== fabric.document && fabric.util.getElementPosition(n) === "fixed" && (a = n), n !== fabric.document && s !== t && fabric.util.getElementPosition(n) === "absolute" ? (o = 0, u = 0) : n === fabric.document && s !== t ? (o = r.scrollLeft || i.scrollLeft || 0, u = r.scrollTop || i.scrollTop || 0) : (o += n.scrollLeft || 0, u += n.scrollTop || 0);
    ...
    fabric.isTouchSupported && (d = function (e) {
        return e.type !== "touchend" ? e.touches && e.touches[0] ? e.touches[0].pageX - (e.touches[0].
            pageX - e.touches[0].clientX) || e.clientX : e.clientX : e.changedTouches && e.changedTouches[0] ? e.changedTouches[0].pageX - (e.changedTouches[0].pageX - e.changedTouches[0].clientX) || e.clientX : e.clientX
    }, v = function (e) {
    ...
    function a(e) {
        var t, n, r = {left:0, top:0}, i = e && e.ownerDocument;
        return i ? (t = i.documentElement, typeof e.getBoundingClientRect != "undefined" && (r = e.getBoundingClientRect()), i != null && i === i.window ? n = i : n = i.nodeType === 9 && i.defaultView, {left:r.left + n.pageXOffset - (t.clientLeft || 0), top:r.top + n.pageYOffset - (t.clientTop || 0)}) : {left:0, top:0}
    }
    ...
    var f;
    fabric.document.defaultView && fabric.document.defaultView.getComputedStyle ? f = function (e) {
        return fabric.document.defaultView.getComputedStyle(e, null).position
    } : f = function (e) {
        var t = e.style.position;
        return!t && e.currentStyle && (t = e.currentStyle.position), t
    }, function () {
        function n(e) {
    ...
    }(), fabric.util.getById = t, fabric.util.toArray = n, fabric.util.makeElement = s, fabric.util.addClass = o, fabric.util.wrapElement = u, fabric.util.getElementOffset = a, fabric.util.getElementPosition = f
}(), function () {
    function e(e, t) {
        return e + (/\?/.test(e) ? "&" : "?") + t
    }
    ...
    function a(e, n, r) {
        var i;
        e !== "fill" && e !== "stroke" || n !== "none" ? e === "fillRule" ? n = n === "evenodd" ? "destination-over" : n : e === "strokeDashArray" ? n = n.replace(/,/g, " ").split(/\s+/) : e === "transformMatrix" && (r && r.transformMatrix && (n = s(r.transformMatrix, t.parseTransformAttribute(n))), n = t.parseTransformAttribute(n)) : n = "", i = Object.prototype.toString.call(n) === "[object Array]";
        var o = i ? n.map(parseFloat) : parseFloat(n);
        return!i && isNaN(o) ? n : o
    }
    ...
    function f(e, r) {
        ...
        var o = r.reduce(function (t, n) {
            return i = e.getAttribute(n), i && (n = u(n), i = a(n, i, s), t[n] = i), t
        }, {});
        return o = n(o, n(m(e), t.parseStyleAttribute(e))), n(s, o)
    }
    ...
    function c(e, t) {
        var n = e.match(/(normal|italic)?\s*(normal|small-caps)?\s*(normal|bold|bolder|lighter|100|200|300|400|500|600|700|800|900)?\s*(\d+)px\s+(.*)/);
        if (!n)return;
        var r = n[1], i = n[3], s = n[4], o = n[5];
        r && (t.fontStyle = r), i && (t.fontSize = isNaN(parseFloat(i)) ? i : parseFloat(i)), s && (t.fontSize = parseFloat(s)), o && (t.fontFamily = o)
    }
    ...
    function h(e) {
        ...
        if (typeof n == "string")n.replace(/;$/, "").split(";").forEach(function (e) {
            var n = e.split(":");
            r = u(n[0].trim().toLowerCase()), i = a(r, n[1].trim()), r === "font" ? c(i, t) : t[r] = i
        }); else for (var s in n) {
            if (typeof n[s] == "undefined")continue;
            r = u(s.toLowerCase()), i = a(r, n[s]), r === "font" ? c(i, t) : t[r] = i
        }
        return t
    }
        ...
        for (var f = 0, l, c = e.length; f < c; f++) {
            ...
            if (h && h.fromElement)try {
                if (h.async)h.fromElement(l, function (e, t) {
                    ...
                    var d = h.fromElement(l, i);
                    s && s(l, d), o.splice(f, 0, d), a()
                }
            } catch (v) {
                t.log(v)
            } else a()
    ...
    function y(e, n, r) {
        function i(i) {
            ...
            t.parseSVGDocument(s.documentElement, function (r, i) {
                g.set(e, {objects:t.util.array.invoke(r, "toObject"), options:i}), n(r, i)
            }, r)
        }
    ...
    t.parseTransformAttribute = function () {
        ...
        return function (n, o, u) {
            ...
            var d = n.getAttribute("viewBox"), m = n.getAttribute("width"), g = n.getAttribute("height"), y = null, b = null, w, E;
            d && (d = d.match(r)) && (w = parseInt(d[1], 10), E = parseInt(d[2], 10), y = parseInt(d[3], 10), b = parseInt(d[4], 10)), y = m ? parseFloat(m) : y, b = g ? parseFloat(g) : b;
            var S = {width:y, height:b};
            t.gradientDefs = t.getGradientDefs(n), t.cssRules = v(n), t.parseElements(p, function (e) {
                t.documentParsingTime = new Date - a, o && o(e, S)
            }, i(S), u)
        }
    }();
    var g = {has:function (e, t) {
        t(!1)
    }, get:function () {
    }, set:function () {
    }};
    n(t, {parseAttributes:f, parseElements:d, parseStyleAttribute:h, parsePointsAttribute:l, getCSSRules:v, loadSVGFromURL:y, loadSVGFromString:w, createSVGFontFacesMarkup:E, createSVGRefElementsMarkup:S})
    ...
    function e(e) {
        ...
        return r || (r = e.getAttribute("stop-color")), i || (i = e.getAttribute("stop-opacity")), r = (new fabric.Color(r)).toRgb(), {offset:n, color:r, opacity:i}
    }
    ...
    fabric.Gradient = fabric.util.createClass({initialize:function (e) {
        ...
        var t;
        if (!this.type)return;
        this.type === "linear" ? t = e.createLinearGradient(this.coords.x1, this.coords.y1, this.coords.x2 || e.canvas.width, this.coords.y2) : this.type === "radial" && (t = e.createRadialGradient(this.coords.x1, this.coords.y1, this.coords.r1, this.coords.x2, this.coords.y2, this.coords.r2));
        for (var n = 0; n < this.colorStops.length; n++) {
            var r = this.colorStops[n].color, i = this.colorStops[n].opacity, s = this.colorStops[n].offset;
            i && (r = (new fabric.Color(r)).setAlpha(i).toRgba()), t.addColorStop(parseFloat(s), r)
        }
        return t
    ...
    }}), fabric.getGradientDefs = r
}(), fabric.Pattern = fabric.util.createClass({repeat:"repeat", offsetX:0, offsetY:0, initialize:function (e) {
    e || (e = {}), e.source && (this.source = typeof e.source == "string" ? new Function(e.source) : e.source), e.repeat && (this.repeat = e.repeat), e.offsetX && (this.offsetX = e.offsetX), e.offsetY && (this.offsetY = e.offsetY)
}, toObject:function () {
    var e;
    return typeof this.source == "function" ? e = String(this.source).match(/function\s+\w*\s*\(.*\)\s+\{([\s\S]*)\}/)[1] : typeof this.source.src == "string" && (e = this.source.src), {source:e, repeat:this.repeat, offsetX:this.offsetX, offsetY:this.offsetY}
}, toLive:function (e) {
    var t = typeof this.source == "function" ? this.source() : this.source;
    return e.createPattern(t, this.repeat)
}}), fabric.Shadow = fabric.util.createClass({color:"rgb(0,0,0)", blur:0, offsetX:0, offsetY:0, affectStroke:!1, initialize:function (e) {
    ...
    t.Point = n, n.prototype = {constructor:n, init:function (e, t) {
        this.x = e, this.y = t
    }, add:function (e) {
    ...
    t.Intersection = n, t.Intersection.prototype = {init:function (e) {
        ...
        var i = new n("No Intersection"), s = r.length;
        for (var o = 0; o < s; o++) {
        ...
        var r = new n("No Intersection"), i = e.length;
        for (var s = 0; s < i; s++) {
        ...
        var s = r.min(i), o = r.max(i), u = new t.Point(o.x, s.y), a = new t.Point(s.x, o.y), f = n.intersectLinePolygon(s, u, e), l = n.intersectLinePolygon(u, o, e), c = n.intersectLinePolygon(o, a, e), h = n.intersectLinePolygon(a, s, e), p = new n("No Intersection");
    ...
    t.Color = n, t.Color.prototype = {_tryParsingColor:function (e) {
        var t;
        e in n.colorNameMap && (e = n.colorNameMap[e]), t = n.sourceFromHex(e), t || (t = n.sourceFromRgb(e)), t && this.setSource(t)
    }, getSource:function () {
        return this._source
    ...
    fabric.StaticCanvas = function (e, t) {
        ...
        for (var r = 0, i = this._objects.length; r < i; ++r)(!n || n && this._objects[r] && !n.contains
            (this._objects[r])) && this._draw(t, this._objects[r]);
        if (n) {
            var s = [];
        ...
        return this.clipTo && t.restore(), this.overlayImage && t.drawImage(this.overlayImage, this.overlayImageLeft, this.overlayImageTop), this.controlsAboveOverlay && this.drawControls(t), this.fire("after:render"), this
        ...
        var n = {objects:this._objects.map(function (n) {
            var r;
        ...
        for (var n = 0, r = this.getObjects(), i = r.length; n < i; n++)t.push(r[n].toSVG());
        ...
        var t = this._objects.indexOf(e), r = t;
        if (t !== 0) {
            for (var i = t - 1; i >= 0; --i) {
        ...
        var t = this.getObjects(), r = t.indexOf(e), i = r;
        if (r !== t.length - 1) {
            for (var s = r + 1, o = this._objects.length; s < o; ++s) {
                var u = e.intersectsWithObject(t[s]) || e.isContainedWithinObject(this._objects[s]) || this._objects[s].isContainedWithinObject(e);
                if (u) {
                    i = s;
                    break
                }
        ...
        var t = e.width || e.offsetWidth, n = this.getWidth() / t;
        t && (e.width = t * n)
    ...
    return String(this.getPatternSrc).match(/function\s+\w*\s*\(.*\)\s+\{([\s\S]*)\}/)[1].replace("this.color", '"' + this.color + '"')
}, getPattern:function () {
    ...
    return t.stroke = new fabric.Pattern({source:this.source || this.getPatternSrcBody()}), t
}}), function () {
    function f() {
    }
    ...
    var l = {uniScaleTransform:!1, centerTransform:!1, interactive:!0, selection:!0, selectionColor:"rgba(100, 100, 255, 0.3)", selectionDashArray:[], selectionBorderColor:"rgba(255, 255, 255, 0.3)", selectionLineWidth:1, hoverCursor:"move", moveCursor:"move", defaultCursor:"default", freeDrawingCursor:"crosshair", rotationCursor:"crosshair", containerClass:"canvas-container", perPixelTargetFind:!1, targetFindTolerance:0, _initInteractive:function () {
        ...
        r.originX === "right" ? f.x *= -1 : r.originX === "center" && (f.x *= r.mouseXSign * 2, f.x < 0 && (r.mouseXSign = -r.mouseXSign)), r.originY === "bottom" ? f.y *= -1 : r.originY === "center" && (f.y *= r.mouseYSign * 2, f.y < 0 && (r.mouseYSign = -r.mouseYSign));
        var l = s.scaleX, c = s.scaleY;
        if (n === "equally" && !o && !u) {
            var h = f.y + f.x, p = s.height * r.original.scaleY + s.width * r.original.scaleX + s.padding * 2 - s.strokeWidth * 2 + 1;
            l = r.original.scaleX * h / p, c = r.original.scaleY * h / p, s.set("scaleX", l), s.set("scaleY", c)
        } else n ? n === "x" && !s.get("lockUniScaling") ? (l = f.x / (s.width + s.padding), o || s.set("scaleX", l)) : n === "y" && !s.get("lockUniScaling") && (c = f.y / (s.height + s.padding), u || s.set("scaleY", c)) : (l = f.x / (s.width + s.padding), c = f.y / (s.height + s.padding), o || s.set("scaleX", l), u || s.set("scaleY", c));
        l < 0 && (r.originX === "left" ? r.originX = "right" : r.originX === "right" && (r.originX = "left")), c < 0 && (r.originY === "top" ? r.originY = "bottom" : r.originY === "bottom" && (r.originY = "top")), s.setPositionByOrigin(a, r.originX, r.originY)
    }, _rotateObject:function (e, t) {
        var n = this._currentTransform, s = this._offset;
        if (n.target.get("lockRotation"))return;
        var o = i(n.ey - n.top - s.top, n.ex - n.left - s.left), u = i(t - n.top - s.top, e - n.left - s.left);
        n.target.angle = r(u - o + n.theta)
        ...
        var t = [], n = this._groupSelector.ex, r = this._groupSelector.ey, i = n + this._groupSelector.left, s = r + this._groupSelector.top, a, f = new fabric.Point(o(n, i), o(r, s)), l = new fabric.Point(u(n, i), u(r, s));
        for (var c = 0, h = this._objects.length; c < h; ++c) {
            a = this._objects[c];
            if (!a)continue;
            (a.intersectsWithRect(f, l) || a.isContainedWithinRect(f, l) || a.containsPoint(f) || a.containsPoint(l)) && this.selection && a.selectable && (a.set("active", !0), t.push(a))
        }
        t.length === 1 ? this.setActiveObject(t[0], e) : t.length > 1 && (t = new fabric.Group(t), this.setActiveGroup(t), t.saveCoords(), this.fire("selection:created", {target:t}), this.renderAll())
    ...
    var e = {tr:"ne-resize", br:"se-resize", bl:"sw-resize", tl:"nw-resize", ml:"w-resize", mt:"n-resize", mr:"e-resize", mb:"s-resize"}, t = fabric.util.addListener, n = fabric.util.removeListener, r = fabric.util.getPointer;
    fabric.util.object.extend(fabric.Canvas.prototype, {_initEvents:function () {
        ...
        if (i)n = r(e, this.upperCanvasEl), i.left = n.x - this._offset.left - i.ex, i.top = n.y - this._offset.top - i.ey, this.renderTop(); else if (!this._currentTransform) {
        ...
        if (!n)return r.cursor = this.defaultCursor, !1;
        var i = this.getActiveGroup(), s = n._findTargetCorner && (!i || !i.contains(n)) && n._findTargetCorner(t, this._offset);
        if (!s)r.cursor = this.hoverCursor; else if (s in e)r.cursor = e[s]; else {
            if (s !== "mtr" || !n.hasRotatingPoint)return r.cursor = this.defaultCursor, !1;
    ...
    if (!n)return;
    n.objects || (n.objects = []), this.clear();
    var r = this;
    this._enlivenDatalessObjects(n.objects, function () {
        r._setBgOverlayImages(n, t)
    })
}, _enlivenDatalessObjects:function (e, t) {
    function s(e, s) {
        n.insertAt(e, s, !0), e.setCoords(), ++r === i && t && t()
    }

    function o(e, t) {
        var n = e.paths ? "paths" : "path", r = e[n];
        delete e[n];
        if (typeof r != "string")if (e.type === "image" || e.type === "group")fabric[fabric.util.string.capitalize(e.type)].fromObject(e, function (e) {
            s(e, t)
        }); else {
            var i = fabric[fabric.util.string.camelize(fabric.util.string.capitalize(e.type))];
            if (!i || !i.fromObject)return;
            r && (e[n] = r), s(i.fromObject(e), t)
        } else if (e.type === "image")fabric.util.loadImage(r, function (n) {
            var i = new fabric.Image(n);
            i.setSourcePath(r), fabric.util.object.extend(i, e), i.setAngle(e.angle), s(i, t)
        }); else if (e.type === "text")if (e.useNative)s(fabric.Text.fromObject(e), t); else {
            e.path = r;
            var o = fabric.Text.fromObject(e), u = function () {
                Object.prototype.toString.call(fabric.window.opera) === "[object Opera]" ? setTimeout(function () {
                    s(o, t)
                }, 500) : s(o, t)
            };
            fabric.util.getScript(r, u)
        } else fabric.loadSVGFromURL(r, function (n) {
            var i = fabric.util.groupSVGElements(n, e, r);
            i instanceof fabric.PathGroup || (fabric.util.object.extend(i, e), typeof e.angle != "undefined" && i.setAngle(e.angle)), s(i, t)
        })
    }

    var n = this, r = 0, i = e.length;
    i === 0 && t && t();
    try {
        e.forEach(o, this)
    } catch (u) {
    ...
    if (!e)return;
    var n = typeof e == "string" ? JSON.parse(e) : e, r = this;
    ...
    t.Object = t.util.createClass({type:"object", originX:"center", originY:"center", top:0, left:0, width:0, height:0, scaleX:1, scaleY:1, flipX:!1, flipY:!1, opacity:1, angle:0, cornerSize:12, transparentCorners:!0, padding:0, borderColor:"rgba(102,153,255,0.75)", cornerColor:"rgba(102,153,255,0.5)", fill:"rgb(0,0,0)", fillRule:"source-over", overlayFill:null, stroke:null, strokeWidth:1, strokeDashArray:null, strokeLineCap:"butt", strokeLineJoin:"miter", strokeMiterLimit:10, shadow:null, borderOpacityWhenMoving:.4, borderScaleFactor:1, transformMatrix:null, minScaleLimit:.01, selectable:!0, visible:!0, hasControls:!0, hasBorders:!0, hasRotatingPoint:!0, rotatingPointOffset:40, perPixelTargetFind:!1, includeDefaultValues:!0, clipTo:null, lockMovementX:!1, lockMovementY:!1, lockRotation:!1, lockScalingX:!1, lockScalingY:!1, lockUniScaling:!1, stateProperties:"top left width height scaleX scaleY flipX flipY angle opacity cornerSize fill overlayFill originX originY stroke strokeWidth strokeDashArray fillRule borderScaleFactor transformMatrix selectable shadow visible".split(" "), initialize:function (e) {
        ...
        this._initGradient(e), this._initPattern(e), this._initShadow(e)
        ...
        if (typeof e == "object")for (var n in e)this._set(n, e[n]); else typeof t == "function" ? this._set(e, t(this.get(e))) : this._set(e, t);
        return this
    }, _set:function (e, t) {
        ...
        r && !this.group && e.setTransform(r[0], r[1], r[2], r[3], r[4], r[5]), n || this.transform(e), e.save(), this.stroke && (e.lineWidth = this.strokeWidth, e.lineCap = this.strokeLineCap, e.lineJoin = this.strokeLineJoin, e.miterLimit = this.strokeMiterLimit, e.strokeStyle = this.stroke.toLive ? this.stroke.toLive(e) : this.stroke), this.overlayFill ? e.fillStyle = this.overlayFill : this.fill && (e.fillStyle = this.fill.toLive ? this.fill.toLive(e) : this.fill), r && this.group && (e.translate(-this.group.width / 2, -this.group.height / 2), e.transform(r[0], r[1], r[2], r[3], r[4], r[5])), this._setShadow(e), this.clipTo && t.util.clipContext(this, e), this._render(e, n), this.clipTo && e.restore(), this._removeShadow(e), e.restore(), this.active && !n && (this.drawBorders(e), this.drawControls(e)), e.restore()
        ...
        this.strokeDashArray ? (1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray), o ? (e.setLineDash(this.strokeDashArray), this._stroke && this._stroke(e)) : this._renderDashedStroke && this._renderDashedStroke(e), e.stroke()) : this._stroke ? this._stroke(e) : e.stroke(), this._removeShadow(e)
    }, clone:function (e, n) {
        ...
        return this.group ? t.StaticCanvas.prototype.sendBackwards.call(this.group, this) : this.canvas.sendBackwards(this), this
    }, bringForward:function () {
        return this.group ? t.StaticCanvas.prototype.bringForward.call(this.group, this) : this.canvas.bringForward(this), this
    }, moveTo:function (e) {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {translateToCenterPoint:function (t, n, r) {
        var i = t.x, s = t.y;
        return n === "left" ? i = t.x + this.getWidth() / 2 : n === "right" && (i = t.x - this.getWidth() / 2), r === "top" ? s = t.y + this.getHeight() / 2 : r === "bottom" && (s = t.y - this.getHeight() / 2), fabric.util.rotatePoint(new fabric.Point(i, s), t, e(this.angle))
        ...
        return n !== undefined && r !== undefined ? (n === "left" ? s = i.x - this.getWidth() / 2 : n === "right" ? s = i.x + this.getWidth() / 2 : s = i.x, r === "top" ? o = i.y - this.getHeight() / 2 : r === "bottom" ? o = i.y + this.getHeight() / 2 : o = i.y) : (s = this.left, o = this.top), fabric.util.rotatePoint(new fabric.Point(t.x, t.y), i, -e(this.angle)).subtractEquals(new fabric.Point(s, o))
    ...
    fabric.util.object.extend(fabric.Object.prototype, {intersectsWithRect:function (e, t) {
        ...
        return this.oCoords = {tl:c, tr:h, br:p, bl:d, ml:v, mt:m, mr:g, mb:y, mtr:b}, this._setCornerCoords(), this
    }})
    ...
    t.Line = t.util.createClass(t.Object, {type:"line", initialize:function (e, t) {
        ...
        var n = this.width === 1 ? 0 : -this.width / 2, r = this.height === 1 ? 0 : -this.height / 2;
        e.beginPath(), t.util.drawDashedLine(e, n, r, -n, -r, this.strokeDashArray), e.closePath()
    }, toObject:function (e) {
    ...
    t.Rect = t.util.createClass(t.Object, {type:"rect", rx:0, ry:0, strokeDashArray:null, initialize:function (e) {
        e = e || {}, this._initStateProperties(), this.callSuper("initialize"
            , e), this._initRxRy(), this.x = 0, this.y = 0
        ...
        e.beginPath(), e.globalAlpha = u ? e.globalAlpha * this.opacity : this.opacity, this.transformMatrix && u && e.translate(this.width / 2 + this.x, this.height / 2 + this.y), !this.transformMatrix && u && e.translate(-this.group.width / 2 + this.width / 2 + this.x, -this.group.height / 2 + this.height / 2 + this.y), e.moveTo(r + t, i), e.lineTo(r + s - t, i), e.quadraticCurveTo(r + s, i, r + s, i + n, r + s, i + n), e.lineTo(r + s, i + o - n), e.quadraticCurveTo(r + s, i + o, r + s - t, i + o, r + s - t, i + o), e.lineTo(r + t, i + o), e.quadraticCurveTo(r, i + o, r, i + o - n, r, i + o - n), e.lineTo(r, i + n), e.quadraticCurveTo(r, i, r + t, i, r + t, i), e.closePath(), this._renderFill(e), this._renderStroke(e)
    }, _renderDashedStroke:function (e) {
        ...
        return n(this.callSuper("toObject", e), {rx:this.get("rx") || 0, ry:this.get("ry") || 0})
    }, toSVG:function () {
        var e = [];
    ...
    function n(e, t, n, r) {
        var i = r[0], s = r[1], o = r[2], f = r[3], l = r[4], c = r[5], h = r[6], p = u(c, h, i, s, f, l, o, t, n);
    ...
    function u(e, t, n, i, u, a, f, l, c) {
        o = s.call(arguments);
        if (r[o])return r[o];
        var h = f * (Math.PI / 180), p = Math.sin(h), d = Math.cos(h);
        n = Math.abs(n), i = Math.abs(i);
        var v = d * (l - e) * .5 + p * (c - t) * .5, m = d * (c - t) * .5 - p * (l - e) * .5, g = v * v / (n * n) + m * m / (i * i);
        g > 1 && (g = Math.sqrt(g), n *= g, i *= g);
        var y = d / n, b = p / n, w = -p / i, E = d / i, S = y * l + b * c, x = w * l + E * c, T = y * e + b * t, N = w * e + E * t, C = (T - S) * (T - S) + (N - x) * (N - x), k = 1 / C - .25;
        k < 0 && (k = 0);
        var L = Math.sqrt(k);
        a === u && (L = -L);
        var A = .5 * (S + T) - L * (N - x), O = .5 * (x + N) + L * (T - S), M = Math.atan2(x - O, S - A), _ = Math.atan2(N - O, T - A), D = _ - M;
    ...
    function a(e, t, n, r, u, a, f, l) {
        o = s.call(arguments);
        if (i[o])return i[o];
        var c = l * u, h = -f * a, p = f * u, d = l * a, v = .5 * (r - n), m = 8 / 3 * Math.sin(v * .5) * Math.sin(v * .5) / Math.sin(v), g = e + Math.cos(n) - m * Math.sin(n), y = t + Math.sin(n) + m * Math.cos(n), b = e + Math.cos(r), w = t + Math.sin(r), E = b + m * Math.sin(r), S = w - m * Math.cos(r);
        return i[o] = [c * g + h * y, p * g + d * y, c * E + h * S, p * E + d * S, c * b + h * w, p * b + d * w], i[o]
    }
    ...
    var t = {m:2, l:2, h:1, v:1, c:6, s:4, q:4, t:2, a:7}, r = {}, i = {}, s = Array.prototype.join, o;
    "use strict";
    var f = e.fabric || (e.fabric = {}), l = f.util.array.min, c = f.util.array.max, h = f.util.object.extend, p = Object.prototype.toString;
    if (f.Path) {
        f.warn("fabric.Path is already defined");
        return
    }
    f.Path = f.util.createClass(f.Object, {type:"path", initialize:function (e, t) {
        ...
        var t = "width"in e, n = "height"in e, r = "left"in e, i = "top"in e;
        !t || !n ? (h(this, this._parseDimensions()), t && (this.width = e.width), n && (this.height = e.height)) : (i || (this.top = this.height / 2), r || (this.left = this.width / 2)), this.pathOffset = this.pathOffset || this._calculatePathOffset(i || r)
    }, _calculatePathOffset:function (e) {
        return{x:e ? 0 : this.left - this.width / 2, y:e ? 0 : this.top - this.height / 2}
    }, _render:function (e) {
        var t, r = null, i = 0, s = 0, o = 0, u = 0, a, f, l, c, h = -(this.width / 2 + this.pathOffset.x), p = -(this.height / 2 + this.pathOffset.y);
        for (var d = 0, v = this.path.length; d < v; ++d) {
            ...
            switch (t[0]) {
                ...
                case"V":
                    ...
                    break;
                case"m":
                    i += t[1], s += t[2], e[!r || r[0] !== "m" && r[0] !== "M" ? "moveTo" : "lineTo"](i + h, s + p);
                    break;
                case"M":
                    i = t[1], s = t[2], e[!r || r[0] !== "m" && r[0] !== "M" ? "moveTo" : "lineTo"](i + h, s + p);
                    break;
                ...
                case"C":
                    ...
                    break;
                case"s":
                    a = i + t[3], f = s + t[4], o = o ? 2 * i - o : i, u = u ? 2 * s - u : s, e.bezierCurveTo(o + h, u + p, i + t[1] + h, s + t[2] + p, a + h, f + p), o = i + t[1], u = s + t[2], i = a, s = f;
                    break;
                case"S":
        ...
        var u = l(e), a = l(t), f = c(e), h = c(t), p = f - u, m = h - a, g = {top:a + m / 2, left:u + p / 2, bottom:c(t) - m, right:c(e) - p};
        return g.width = p, g.height = m, g
    }}), f.Path.fromObject = function (e) {
        return new f.Path(e.path, e)
    }, f.Path.ATTRIBUTE_NAMES = f.SHARED_ATTRIBUTES.concat(["d"]), f.Path.fromElement = function (e, t) {
    ...
    "use strict";
    function u(e) {
        for (var n = 0, r = e.length; n < r; n++)if (!(e[n]instanceof t.Object)) {
            var i = s(o(e[n].type));
    ...
    t.Group = t.util.createClass(t.Object, t.Collection, {type:"group", initialize:function (e, t) {
        ...
        var t = this.get("left"), n = this.get("top"), r = this.getAngle() * (Math.PI / 180), i = Math.cos(r) * e.get("top") + Math.sin(r) * e.get("left"), s = -Math.sin(r) * e.get("top") + Math.cos(r) * e.get("left");
        return e.setAngle(e.getAngle() + this.getAngle()), e.set("left", t + s * this.get("scaleX")), e.set("top", n + i * this.get("scaleY")), e.set("scaleX", e.get("scaleX") * this.get("scaleX")), e.set("scaleY", e.get("scaleY") * this.get("scaleY")), e.setCoords(), e.hasControls = e.__origHasControls, delete e.__origHasControls, e.set("active", !1), e.setCoords(), delete e.group, this
    }, destroy:function () {
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, {type:"image", initialize:function (e, t) {
        ...
        e.save(), e.lineWidth = this.strokeWidth, e.lineCap = this.strokeLineCap, e.lineJoin = this.strokeLineJoin, e.miterLimit = this.strokeMiterLimit, e.strokeStyle = this.stroke.toLive ? this.stroke.toLive(e) : this.stroke, e.beginPath(), e.strokeRect(-this.width / 2, -this.height / 2, this.width, this.height), e.beginPath(), e.restore()
    }, _renderDashedStroke:function (e) {
        var t = -this.width / 2, n = -this.height / 2, r = this.width, i = this.height;
        e.lineWidth = this.strokeWidth, e.lineCap = this.strokeLineCap, e.lineJoin = this.strokeLineJoin, e.miterLimit = this.strokeMiterLimit, e.strokeStyle = this.stroke.toLive ? this.stroke.toLive(e) : this.stroke, e.beginPath(), fabric.util.drawDashedLine(e, t, n, t + r, n, this.strokeDashArray), fabric.util.drawDashedLine(e, t + r, n, t + r, n + i, this.strokeDashArray), fabric.util.drawDashedLine(e, t + r, n + i, t, n + i, this.strokeDashArray), fabric.util.drawDashedLine(e, t, n + i, t, n, this.strokeDashArray), e.closePath()
    }, toObject:function (e) {
...
}}), fabric.Image.filters = {}, fabric.Image.filters.Grayscale = fabric.util.createClass({type:"Grayscale", applyTo:function (e) {
...
}, fabric.Image.filters.RemoveWhite = fabric.util.createClass({type:"RemoveWhite", initialize:function (e) {
...
}, fabric.Image.filters.Invert = fabric.util.createClass({type:"Invert", applyTo:function (e) {
...
}, fabric.Image.filters.Sepia = fabric.util.createClass({type:"Sepia", applyTo:function (e) {
...
}, fabric.Image.filters.Sepia2 = fabric.util.createClass({type:"Sepia2", applyTo:function (e) {
...
}, fabric.Image.filters.Brightness = fabric.util.createClass({type:"Brightness", initialize:function (e) {
...
}, fabric.Image.filters.Noise = fabric.util.createClass({type:"Noise", initialize:function (e) {
...
}, fabric.Image.filters.GradientTransparency = fabric.util.createClass({type:"GradientTransparency", initialize:function (e) {
...
}, fabric.Image.filters.Tint = fabric.util.createClass({type:"Tint", initialize:function (e) {
...
}, fabric.Image.filters.Convolute = fabric.util.createClass({type:"Convolute", initialize:function (e) {
    ...
    return{type:this.type, matrix:this.matrix}
}}), fabric.Image.filters.Convolute.fromObject = function (e) {
    return new fabric.Image.filters.Convolute(e)
}, fabric.Image.filters.Pixelate = fabric.util.createClass({type:"Pixelate", initialize:function (e) {
    ...
    var o = {fontSize:!0, fontWeight:!0, fontFamily:!0, textDecoration:!0, fontStyle:!0, lineHeight:!0, stroke:!0, strokeWidth:!0, text:!0}, u = t.Object.prototype.stateProperties.concat();
    u.push("fontFamily", "fontWeight", "fontSize", "path", "text", "textDecoration", "textShadow", "textAlign", "fontStyle", "lineHeight", "stroke", "strokeWidth", "backgroundColor", "textBackgroundColor", "useNative"), t.Text = t.util.createClass(t.Object, {fontSize:40, fontWeight:"normal", fontFamily:"Times New Roman", textDecoration:"", textShadow:"", textAlign:"left", fontStyle:"", lineHeight:1.3, stroke:"", strokeWidth:1, backgroundColor:"", textBackgroundColor:"", path:null, type:"text", useNative:!0, stateProperties:u, initialize:function (e, t) {
        ...
        return!t.isLikelyNode || this.originY !== "top" && this.originY !== "center" ? -this.height / 2 : 0
    }, _renderTextFill:function (e, t) {
        if (this.fill) {
            this._boundaries = [];
            for (var n = 0, r = t.length; n < r; n++)this._drawTextLine("fillText", e, t[n], this._getLeftOffset(), this._getTopOffset() + (n + 1) * this.fontSize * this.lineHeight)
        }
    }, _renderTextStroke:function (e, t) {
        if (this.stroke) {
            this.strokeDashArray && (1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray), s && e.setLineDash(this.strokeDashArray)), e.beginPath();
            for (var n = 0, r = t.length; n < r; n++)this._drawTextLine("strokeText", e, t[n], this._getLeftOffset(), this._getTopOffset() + (n + 1) * this.fontSize * this.lineHeight);
            e.closePath()
        }
        ...
        this.backgroundColor && (e.save(), e.fillStyle = this.backgroundColor, e.fillRect(this._getLeftOffset(), this._getTopOffset(), this.width, this.height), e.restore())
        ...
        this.textDecoration.indexOf("underline") > -1 && i(this.fontSize * this.lineHeight), this.textDecoration.indexOf("line-through") > -1 && i(this.fontSize * this.lineHeight - this.fontSize / 2), this.textDecoration.indexOf("overline") > -1 && i(0)
        ...
        var e = t.document.createElement("pre"), n = t.document.createElement("div");
        ...
        return n(this.callSuper("toObject", e), {text:this.text, fontSize:this.fontSize, fontWeight:this.fontWeight, fontFamily:this.fontFamily, fontStyle:this.fontStyle, lineHeight:this.lineHeight, textDecoration:this.textDecoration, textShadow:this.textShadow, textAlign:this.textAlign, path:this.path, stroke:this.stroke, strokeWidth:this.strokeWidth, backgroundColor:this.backgroundColor, textBackgroundColor:this.textBackgroundColor, useNative:this.useNative})
    }, toSVG:function () {
        ...
        e === "fontFamily" && this.path && (this.path = this.path.replace(/(.*?)([^\/]*)(\.font\.js)/, "$1" + t + "$3")), this.callSuper("_set", e, t), e in o && (this._initDimensions(), this.setCoords())
    }, complexity:function () {
        return 1
    }}), t.Text.ATTRIBUTE_NAMES = t.SHARED_ATTRIBUTES.concat("x y font-family font-style font-weight font-size text-decoration".split(" ")), t.Text.fromObject = function (e) {
    ...
    function request_fs(e, t) {
        var n = require("fs"), r = n.createReadStream(e), i = "";
    ...
    fabric.util.loadImage = function (e, t, n) {
        ...
        e && e.indexOf("data") === 0 ? (i.src = i._src = e, t && t.call(n, i)) : e && e.indexOf("http") !== 0 ? request_fs(e, r) : e && request(e, "binary", r)
