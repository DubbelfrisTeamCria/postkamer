...
function menuOnclick() {
    ...
    $('#verhuizen').click(function () {
        localStorage.categorie = "verhuizen";
    });
    $('#samenwonen').click(function () {
        localStorage.categorie = "samenwonen";
    });
    $('#housewarming').click(function () {
        localStorage.categorie = "housewarming";
    });
    $('#home').click(function () {
        selectLinesMenu("home");
    });
    $('#overons').click(function () {
        selectLinesMenu("overons");
    });
    $('#hoeWerktHet').click(function () {
        selectLinesMenu("hoeWerktHet");
    });
    $('#contact').click(function () {
        selectLinesMenu("contact");
    });
